...
export const isRB3CompatibleDTA = (song: unknown): song is RB3CompatibleDTAFile => {
  return !Array.isArray(song) && typeof song === 'object' && song !== null && 'name' in song && 'artist' in song && 'id' in song && 'master' in song && 'tracks_count' in song && 'preview' in song && 'vocal_parts' in song && 'pans' in song && 'vols' in song && 'cores' in song && 'bank' in song && 'anim_tempo' in song && 'rank_band' in song && 'genre' in song && 'vocal_gender' in song && 'year_released' in song && 'format' in song && 'version' in song
}
