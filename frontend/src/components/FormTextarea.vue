<template>
  ...
  <div class="mt-1">
    <div
      class="flex items-center rounded-md bg-gray-800 pl-2 outline-1 -outline-offset-1 outline-white/10 focus-within:outline-2 focus-within:-outline-offset-1 focus-within:outline-blue-500"
    >
      <slot></slot>
      <textarea
        rows="4"
