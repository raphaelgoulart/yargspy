  ...
  <tr class="border-t-1 border-gray-800">
    ...
    <td scope="col" class="pr-3 text-right">
      <div class="flex justify-end items-center gap-1">
        <a :href="getDownloadLink(score.replayPath)" :download="getDownloadFileName(score, username, score.song.name, score.song.artist)"><ArrowDownTrayIcon class="w-5 transition-transform duration-200 hover:scale-110" /></a>
        <a @click="open = !open">
