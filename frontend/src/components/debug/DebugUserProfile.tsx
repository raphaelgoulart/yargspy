            ...
            <>
              <div className="!flex-row items-center">
                ...
                <button
                  ...
                  className="mr-1 rounded-xs bg-slate-700 px-2 py-1 text-xs font-bold duration-200 hover:bg-slate-600"
                >
                  {t('token_copy')}
                </button>
                <button
                  ...
                  className="rounded-xs bg-red-700 px-2 py-1 text-xs font-bold duration-200 hover:bg-red-600"
                >
                  {t('token_delete')}
                </button>
              </div>
