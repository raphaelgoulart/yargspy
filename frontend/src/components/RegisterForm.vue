    ...
    <div>
      ...
      <div class="mb-2">
        <FormInput name="email" label="Email" v-model="email" type="email" required>
          <div class="text-gray-500 pr-1.5 pl-0.5">
      ...
      <div class="mb-2">
        <FormInput
          ...
          maxlength="48"
        >
          <div class="text-gray-500 pl-0.5 pr-1.5">
      ...
      <div class="mb-2">
        <FormCheckbox required
          ><span class="text-slate-300"
            >I agree to the
            <RouterLink to="/tospp">Terms of Use, Privacy Policy and Cookie Policy</RouterLink
            >.</span
          ></FormCheckbox
        >
      </div>
      ...
      <div class="mb-2 flex justify-between">
        ...
        <div class="text-xs">
          ...
          <span
            class="text-white font-semibold hover:cursor-pointer inline-block transition-all duration-300 hover:scale-105"
            @click="$emit('login')"
            >Log in</span
          >
        </div>
